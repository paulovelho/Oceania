<?php
	class TestOfMagratheaRoute extends UnitTestCase{
		...
		function testCreatingRoutesRules(){
			echo "<br/> testing MagratheaRoutes: redirecting routes... ";
			$routes = array(
		...
		function testChangeDefaultRoutes(){
			echo "<br/> testing MagratheaRoutes: changing default routes... ";
